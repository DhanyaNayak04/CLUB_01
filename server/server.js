...
mongoose.connect(process.env.MONGO_URI || 'mongodb+srv://dhanyanayak:Dhanya53@cluster0.imzofb9.mongodb.net/clubdb?retryWrites=true&w=majority&appName=Cluster0', mongooseOptions)
  .then(() => {
